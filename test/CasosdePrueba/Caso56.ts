...
console.log('✅ Monto a invertir:', await montoInvertir.getText());
  ...
  console.log('✅ Datos del DAP en PESOS visibles correctamente.');
  ...
  if (visiblePagoApp && visibleTransferencia) {
    console.log('✅ Flujo de simulación de DAP en PESOS completado exitosamente. Se visualizaron ambas opciones de pago.');
  } else {
