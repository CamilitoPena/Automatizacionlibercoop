...
(async () => {
 ...
 await client.$('id=com.libercoop.appliber:id/editTextMontoDAP').setValue('4000000');
  ...
  await client.$('id=com.libercoop.appliber:id/spinner_periodicidad').click();
  await client.$('//android.widget.TextView[@text="6 - Semestral"]').click();
  ...
  if (visiblePagoApp && visibleTransferencia) {
    console.log('✅ Flujo de simulación de DAP en NOW completado exitosamente. Se visualizaron ambas opciones de pago.');
  } else {
